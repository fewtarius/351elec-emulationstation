...
void GuiMenu::openSystemSettings_batocera()
{
	...
	// Hardcode TZ List (tz/2021a) - @zulhailmie
	emuelec_timezones->add("Africa/Abidjan", "Africa/Abidjan", currentTimezone == "Africa/Abidjan");
	emuelec_timezones->add("Africa/Accra", "Africa/Accra", currentTimezone == "Africa/Accra");
	emuelec_timezones->add("Africa/Algiers", "Africa/Algiers", currentTimezone == "Africa/Algiers");
	emuelec_timezones->add("Africa/Bissau", "Africa/Bissau", currentTimezone == "Africa/Bissau");
	emuelec_timezones->add("Africa/Cairo", "Africa/Cairo", currentTimezone == "Africa/Cairo");
	emuelec_timezones->add("Africa/Casablanca", "Africa/Casablanca", currentTimezone == "Africa/Casablanca");
	emuelec_timezones->add("Africa/Ceuta", "Africa/Ceuta", currentTimezone == "Africa/Ceuta");
	emuelec_timezones->add("Africa/El_Aaiun", "Africa/El_Aaiun", currentTimezone == "Africa/El_Aaiun");
	emuelec_timezones->add("Africa/Johannesburg", "Africa/Johannesburg", currentTimezone == "Africa/Johannesburg");
	emuelec_timezones->add("Africa/Juba", "Africa/Juba", currentTimezone == "Africa/Juba");
	emuelec_timezones->add("Africa/Khartoum", "Africa/Khartoum", currentTimezone == "Africa/Khartoum");
	emuelec_timezones->add("Africa/Lagos", "Africa/Lagos", currentTimezone == "Africa/Lagos");
	emuelec_timezones->add("Africa/Maputo", "Africa/Maputo", currentTimezone == "Africa/Maputo");
	emuelec_timezones->add("Africa/Monrovia", "Africa/Monrovia", currentTimezone == "Africa/Monrovia");
	emuelec_timezones->add("Africa/Nairobi", "Africa/Nairobi", currentTimezone == "Africa/Nairobi");
	emuelec_timezones->add("Africa/Ndjamena", "Africa/Ndjamena", currentTimezone == "Africa/Ndjamena");
	emuelec_timezones->add("Africa/Sao_Tome", "Africa/Sao_Tome", currentTimezone == "Africa/Sao_Tome");
	emuelec_timezones->add("Africa/Tripoli", "Africa/Tripoli", currentTimezone == "Africa/Tripoli");
	emuelec_timezones->add("Africa/Tunis", "Africa/Tunis", currentTimezone == "Africa/Tunis");
	emuelec_timezones->add("Africa/Windhoek", "Africa/Windhoek", currentTimezone == "Africa/Windhoek");
	emuelec_timezones->add("America/Adak", "America/Adak", currentTimezone == "America/Adak");
	emuelec_timezones->add("America/Anchorage", "America/Anchorage", currentTimezone == "America/Anchorage");
	emuelec_timezones->add("America/Araguaina", "America/Araguaina", currentTimezone == "America/Araguaina");
	emuelec_timezones->add("America/Argentina/Buenos_Aires", "America/Argentina/Buenos_Aires", currentTimezone == "America/Argentina/Buenos_Aires");
	emuelec_timezones->add("America/Argentina/Catamarca", "America/Argentina/Catamarca", currentTimezone == "America/Argentina/Catamarca");
	emuelec_timezones->add("America/Argentina/Cordoba", "America/Argentina/Cordoba", currentTimezone == "America/Argentina/Cordoba");
	emuelec_timezones->add("America/Argentina/Jujuy", "America/Argentina/Jujuy", currentTimezone == "America/Argentina/Jujuy");
	emuelec_timezones->add("America/Argentina/La_Rioja", "America/Argentina/La_Rioja", currentTimezone == "America/Argentina/La_Rioja");
	emuelec_timezones->add("America/Argentina/Mendoza", "America/Argentina/Mendoza", currentTimezone == "America/Argentina/Mendoza");
	emuelec_timezones->add("America/Argentina/Rio_Gallegos", "America/Argentina/Rio_Gallegos", currentTimezone == "America/Argentina/Rio_Gallegos");
	emuelec_timezones->add("America/Argentina/Salta", "America/Argentina/Salta", currentTimezone == "America/Argentina/Salta");
	emuelec_timezones->add("America/Argentina/San_Juan", "America/Argentina/San_Juan", currentTimezone == "America/Argentina/San_Juan");
	emuelec_timezones->add("America/Argentina/San_Luis", "America/Argentina/San_Luis", currentTimezone == "America/Argentina/San_Luis");
	emuelec_timezones->add("America/Argentina/Tucuman", "America/Argentina/Tucuman", currentTimezone == "America/Argentina/Tucuman");
	emuelec_timezones->add("America/Argentina/Ushuaia", "America/Argentina/Ushuaia", currentTimezone == "America/Argentina/Ushuaia");
	emuelec_timezones->add("America/Asuncion", "America/Asuncion", currentTimezone == "America/Asuncion");
	emuelec_timezones->add("America/Atikokan", "America/Atikokan", currentTimezone == "America/Atikokan");
	emuelec_timezones->add("America/Bahia", "America/Bahia", currentTimezone == "America/Bahia");
	emuelec_timezones->add("America/Bahia_Banderas", "America/Bahia_Banderas", currentTimezone == "America/Bahia_Banderas");
	emuelec_timezones->add("America/Barbados", "America/Barbados", currentTimezone == "America/Barbados");
	emuelec_timezones->add("America/Belem", "America/Belem", currentTimezone == "America/Belem");
	emuelec_timezones->add("America/Belize", "America/Belize", currentTimezone == "America/Belize");
	emuelec_timezones->add("America/Blanc-Sablon", "America/Blanc-Sablon", currentTimezone == "America/Blanc-Sablon");
	emuelec_timezones->add("America/Boa_Vista", "America/Boa_Vista", currentTimezone == "America/Boa_Vista");
	emuelec_timezones->add("America/Bogota", "America/Bogota", currentTimezone == "America/Bogota");
	emuelec_timezones->add("America/Boise", "America/Boise", currentTimezone == "America/Boise");
	emuelec_timezones->add("America/Cambridge_Bay", "America/Cambridge_Bay", currentTimezone == "America/Cambridge_Bay");
	emuelec_timezones->add("America/Campo_Grande", "America/Campo_Grande", currentTimezone == "America/Campo_Grande");
	emuelec_timezones->add("America/Cancun", "America/Cancun", currentTimezone == "America/Cancun");
	emuelec_timezones->add("America/Caracas", "America/Caracas", currentTimezone == "America/Caracas");
	emuelec_timezones->add("America/Cayenne", "America/Cayenne", currentTimezone == "America/Cayenne");
	emuelec_timezones->add("America/Chicago", "America/Chicago", currentTimezone == "America/Chicago");
	emuelec_timezones->add("America/Chihuahua", "America/Chihuahua", currentTimezone == "America/Chihuahua");
	emuelec_timezones->add("America/Costa_Rica", "America/Costa_Rica", currentTimezone == "America/Costa_Rica");
	emuelec_timezones->add("America/Creston", "America/Creston", currentTimezone == "America/Creston");
	emuelec_timezones->add("America/Cuiaba", "America/Cuiaba", currentTimezone == "America/Cuiaba");
	emuelec_timezones->add("America/Curacao", "America/Curacao", currentTimezone == "America/Curacao");
	emuelec_timezones->add("America/Danmarkshavn", "America/Danmarkshavn", currentTimezone == "America/Danmarkshavn");
	emuelec_timezones->add("America/Dawson", "America/Dawson", currentTimezone == "America/Dawson");
	emuelec_timezones->add("America/Dawson_Creek", "America/Dawson_Creek", currentTimezone == "America/Dawson_Creek");
	emuelec_timezones->add("America/Denver", "America/Denver", currentTimezone == "America/Denver");
	emuelec_timezones->add("America/Detroit", "America/Detroit", currentTimezone == "America/Detroit");
	emuelec_timezones->add("America/Edmonton", "America/Edmonton", currentTimezone == "America/Edmonton");
	emuelec_timezones->add("America/Eirunepe", "America/Eirunepe", currentTimezone == "America/Eirunepe");
	emuelec_timezones->add("America/El_Salvador", "America/El_Salvador", currentTimezone == "America/El_Salvador");
	emuelec_timezones->add("America/Fortaleza", "America/Fortaleza", currentTimezone == "America/Fortaleza");
	emuelec_timezones->add("America/Fort_Nelson", "America/Fort_Nelson", currentTimezone == "America/Fort_Nelson");
	emuelec_timezones->add("America/Glace_Bay", "America/Glace_Bay", currentTimezone == "America/Glace_Bay");
	emuelec_timezones->add("America/Goose_Bay", "America/Goose_Bay", currentTimezone == "America/Goose_Bay");
	emuelec_timezones->add("America/Grand_Turk", "America/Grand_Turk", currentTimezone == "America/Grand_Turk");
	emuelec_timezones->add("America/Guatemala", "America/Guatemala", currentTimezone == "America/Guatemala");
	emuelec_timezones->add("America/Guayaquil", "America/Guayaquil", currentTimezone == "America/Guayaquil");
	emuelec_timezones->add("America/Guyana", "America/Guyana", currentTimezone == "America/Guyana");
	emuelec_timezones->add("America/Halifax", "America/Halifax", currentTimezone == "America/Halifax");
	emuelec_timezones->add("America/Havana", "America/Havana", currentTimezone == "America/Havana");
	emuelec_timezones->add("America/Hermosillo", "America/Hermosillo", currentTimezone == "America/Hermosillo");
	emuelec_timezones->add("America/Indiana/Indianapolis", "America/Indiana/Indianapolis", currentTimezone == "America/Indiana/Indianapolis");
	emuelec_timezones->add("America/Indiana/Knox", "America/Indiana/Knox", currentTimezone == "America/Indiana/Knox");
	emuelec_timezones->add("America/Indiana/Marengo", "America/Indiana/Marengo", currentTimezone == "America/Indiana/Marengo");
	emuelec_timezones->add("America/Indiana/Petersburg", "America/Indiana/Petersburg", currentTimezone == "America/Indiana/Petersburg");
	emuelec_timezones->add("America/Indiana/Tell_City", "America/Indiana/Tell_City", currentTimezone == "America/Indiana/Tell_City");
	emuelec_timezones->add("America/Indiana/Vevay", "America/Indiana/Vevay", currentTimezone == "America/Indiana/Vevay");
	emuelec_timezones->add("America/Indiana/Vincennes", "America/Indiana/Vincennes", currentTimezone == "America/Indiana/Vincennes");
	emuelec_timezones->add("America/Indiana/Winamac", "America/Indiana/Winamac", currentTimezone == "America/Indiana/Winamac");
	emuelec_timezones->add("America/Inuvik", "America/Inuvik", currentTimezone == "America/Inuvik");
	emuelec_timezones->add("America/Iqaluit", "America/Iqaluit", currentTimezone == "America/Iqaluit");
	emuelec_timezones->add("America/Jamaica", "America/Jamaica", currentTimezone == "America/Jamaica");
	emuelec_timezones->add("America/Juneau", "America/Juneau", currentTimezone == "America/Juneau");
	emuelec_timezones->add("America/Kentucky/Louisville", "America/Kentucky/Louisville", currentTimezone == "America/Kentucky/Louisville");
	emuelec_timezones->add("America/Kentucky/Monticello", "America/Kentucky/Monticello", currentTimezone == "America/Kentucky/Monticello");
	emuelec_timezones->add("America/La_Paz", "America/La_Paz", currentTimezone == "America/La_Paz");
	emuelec_timezones->add("America/Lima", "America/Lima", currentTimezone == "America/Lima");
	emuelec_timezones->add("America/Los_Angeles", "America/Los_Angeles", currentTimezone == "America/Los_Angeles");
	emuelec_timezones->add("America/Maceio", "America/Maceio", currentTimezone == "America/Maceio");
	emuelec_timezones->add("America/Managua", "America/Managua", currentTimezone == "America/Managua");
	emuelec_timezones->add("America/Manaus", "America/Manaus", currentTimezone == "America/Manaus");
	emuelec_timezones->add("America/Martinique", "America/Martinique", currentTimezone == "America/Martinique");
	emuelec_timezones->add("America/Matamoros", "America/Matamoros", currentTimezone == "America/Matamoros");
	emuelec_timezones->add("America/Mazatlan", "America/Mazatlan", currentTimezone == "America/Mazatlan");
	emuelec_timezones->add("America/Menominee", "America/Menominee", currentTimezone == "America/Menominee");
	emuelec_timezones->add("America/Merida", "America/Merida", currentTimezone == "America/Merida");
	emuelec_timezones->add("America/Metlakatla", "America/Metlakatla", currentTimezone == "America/Metlakatla");
	emuelec_timezones->add("America/Mexico_City", "America/Mexico_City", currentTimezone == "America/Mexico_City");
	emuelec_timezones->add("America/Miquelon", "America/Miquelon", currentTimezone == "America/Miquelon");
	emuelec_timezones->add("America/Moncton", "America/Moncton", currentTimezone == "America/Moncton");
	emuelec_timezones->add("America/Monterrey", "America/Monterrey", currentTimezone == "America/Monterrey");
	emuelec_timezones->add("America/Montevideo", "America/Montevideo", currentTimezone == "America/Montevideo");
	emuelec_timezones->add("America/Nassau", "America/Nassau", currentTimezone == "America/Nassau");
	emuelec_timezones->add("America/New_York", "America/New_York", currentTimezone == "America/New_York");
	emuelec_timezones->add("America/Nipigon", "America/Nipigon", currentTimezone == "America/Nipigon");
	emuelec_timezones->add("America/Nome", "America/Nome", currentTimezone == "America/Nome");
	emuelec_timezones->add("America/Noronha", "America/Noronha", currentTimezone == "America/Noronha");
	emuelec_timezones->add("America/North_Dakota/Beulah", "America/North_Dakota/Beulah", currentTimezone == "America/North_Dakota/Beulah");
	emuelec_timezones->add("America/North_Dakota/Center", "America/North_Dakota/Center", currentTimezone == "America/North_Dakota/Center");
	emuelec_timezones->add("America/North_Dakota/New_Salem", "America/North_Dakota/New_Salem", currentTimezone == "America/North_Dakota/New_Salem");
	emuelec_timezones->add("America/Nuuk", "America/Nuuk", currentTimezone == "America/Nuuk");
	emuelec_timezones->add("America/Ojinaga", "America/Ojinaga", currentTimezone == "America/Ojinaga");
	emuelec_timezones->add("America/Panama", "America/Panama", currentTimezone == "America/Panama");
	emuelec_timezones->add("America/Pangnirtung", "America/Pangnirtung", currentTimezone == "America/Pangnirtung");
	emuelec_timezones->add("America/Paramaribo", "America/Paramaribo", currentTimezone == "America/Paramaribo");
	emuelec_timezones->add("America/Phoenix", "America/Phoenix", currentTimezone == "America/Phoenix");
	emuelec_timezones->add("America/Port-au-Prince", "America/Port-au-Prince", currentTimezone == "America/Port-au-Prince");
	emuelec_timezones->add("America/Port_of_Spain", "America/Port_of_Spain", currentTimezone == "America/Port_of_Spain");
	emuelec_timezones->add("America/Porto_Velho", "America/Porto_Velho", currentTimezone == "America/Porto_Velho");
	emuelec_timezones->add("America/Puerto_Rico", "America/Puerto_Rico", currentTimezone == "America/Puerto_Rico");
	emuelec_timezones->add("America/Punta_Arenas", "America/Punta_Arenas", currentTimezone == "America/Punta_Arenas");
	emuelec_timezones->add("America/Rainy_River", "America/Rainy_River", currentTimezone == "America/Rainy_River");
	emuelec_timezones->add("America/Rankin_Inlet", "America/Rankin_Inlet", currentTimezone == "America/Rankin_Inlet");
	emuelec_timezones->add("America/Recife", "America/Recife", currentTimezone == "America/Recife");
	emuelec_timezones->add("America/Regina", "America/Regina", currentTimezone == "America/Regina");
	emuelec_timezones->add("America/Resolute", "America/Resolute", currentTimezone == "America/Resolute");
	emuelec_timezones->add("America/Rio_Branco", "America/Rio_Branco", currentTimezone == "America/Rio_Branco");
	emuelec_timezones->add("America/Santarem", "America/Santarem", currentTimezone == "America/Santarem");
	emuelec_timezones->add("America/Santiago", "America/Santiago", currentTimezone == "America/Santiago");
	emuelec_timezones->add("America/Santo_Domingo", "America/Santo_Domingo", currentTimezone == "America/Santo_Domingo");
	emuelec_timezones->add("America/Sao_Paulo", "America/Sao_Paulo", currentTimezone == "America/Sao_Paulo");
	emuelec_timezones->add("America/Scoresbysund", "America/Scoresbysund", currentTimezone == "America/Scoresbysund");
	emuelec_timezones->add("America/Sitka", "America/Sitka", currentTimezone == "America/Sitka");
	emuelec_timezones->add("America/St_Johns", "America/St_Johns", currentTimezone == "America/St_Johns");
	emuelec_timezones->add("America/Swift_Current", "America/Swift_Current", currentTimezone == "America/Swift_Current");
	emuelec_timezones->add("America/Tegucigalpa", "America/Tegucigalpa", currentTimezone == "America/Tegucigalpa");
	emuelec_timezones->add("America/Thule", "America/Thule", currentTimezone == "America/Thule");
	emuelec_timezones->add("America/Thunder_Bay", "America/Thunder_Bay", currentTimezone == "America/Thunder_Bay");
	emuelec_timezones->add("America/Tijuana", "America/Tijuana", currentTimezone == "America/Tijuana");
	emuelec_timezones->add("America/Toronto", "America/Toronto", currentTimezone == "America/Toronto");
	emuelec_timezones->add("America/Vancouver", "America/Vancouver", currentTimezone == "America/Vancouver");
	emuelec_timezones->add("America/Whitehorse", "America/Whitehorse", currentTimezone == "America/Whitehorse");
	emuelec_timezones->add("America/Winnipeg", "America/Winnipeg", currentTimezone == "America/Winnipeg");
	emuelec_timezones->add("America/Yakutat", "America/Yakutat", currentTimezone == "America/Yakutat");
	emuelec_timezones->add("America/Yellowknife", "America/Yellowknife", currentTimezone == "America/Yellowknife");
	emuelec_timezones->add("Antarctica/Casey", "Antarctica/Casey", currentTimezone == "Antarctica/Casey");
	emuelec_timezones->add("Antarctica/Davis", "Antarctica/Davis", currentTimezone == "Antarctica/Davis");
	emuelec_timezones->add("Antarctica/DumontDUrville", "Antarctica/DumontDUrville", currentTimezone == "Antarctica/DumontDUrville");
	emuelec_timezones->add("Antarctica/Macquarie", "Antarctica/Macquarie", currentTimezone == "Antarctica/Macquarie");
	emuelec_timezones->add("Antarctica/Mawson", "Antarctica/Mawson", currentTimezone == "Antarctica/Mawson");
	emuelec_timezones->add("Antarctica/Palmer", "Antarctica/Palmer", currentTimezone == "Antarctica/Palmer");
	emuelec_timezones->add("Antarctica/Rothera", "Antarctica/Rothera", currentTimezone == "Antarctica/Rothera");
	emuelec_timezones->add("Antarctica/Syowa", "Antarctica/Syowa", currentTimezone == "Antarctica/Syowa");
	emuelec_timezones->add("Antarctica/Troll", "Antarctica/Troll", currentTimezone == "Antarctica/Troll");
	emuelec_timezones->add("Antarctica/Vostok", "Antarctica/Vostok", currentTimezone == "Antarctica/Vostok");
	emuelec_timezones->add("Asia/Almaty", "Asia/Almaty", currentTimezone == "Asia/Almaty");
	emuelec_timezones->add("Asia/Amman", "Asia/Amman", currentTimezone == "Asia/Amman");
	emuelec_timezones->add("Asia/Anadyr", "Asia/Anadyr", currentTimezone == "Asia/Anadyr");
	emuelec_timezones->add("Asia/Aqtau", "Asia/Aqtau", currentTimezone == "Asia/Aqtau");
	emuelec_timezones->add("Asia/Aqtobe", "Asia/Aqtobe", currentTimezone == "Asia/Aqtobe");
	emuelec_timezones->add("Asia/Ashgabat", "Asia/Ashgabat", currentTimezone == "Asia/Ashgabat");
	emuelec_timezones->add("Asia/Atyrau", "Asia/Atyrau", currentTimezone == "Asia/Atyrau");
	emuelec_timezones->add("Asia/Baghdad", "Asia/Baghdad", currentTimezone == "Asia/Baghdad");
	emuelec_timezones->add("Asia/Baku", "Asia/Baku", currentTimezone == "Asia/Baku");
	emuelec_timezones->add("Asia/Bangkok", "Asia/Bangkok", currentTimezone == "Asia/Bangkok");
	emuelec_timezones->add("Asia/Barnaul", "Asia/Barnaul", currentTimezone == "Asia/Barnaul");
	emuelec_timezones->add("Asia/Beirut", "Asia/Beirut", currentTimezone == "Asia/Beirut");
	emuelec_timezones->add("Asia/Bishkek", "Asia/Bishkek", currentTimezone == "Asia/Bishkek");
	emuelec_timezones->add("Asia/Brunei", "Asia/Brunei", currentTimezone == "Asia/Brunei");
	emuelec_timezones->add("Asia/Chita", "Asia/Chita", currentTimezone == "Asia/Chita");
	emuelec_timezones->add("Asia/Choibalsan", "Asia/Choibalsan", currentTimezone == "Asia/Choibalsan");
	emuelec_timezones->add("Asia/Colombo", "Asia/Colombo", currentTimezone == "Asia/Colombo");
	emuelec_timezones->add("Asia/Damascus", "Asia/Damascus", currentTimezone == "Asia/Damascus");
	emuelec_timezones->add("Asia/Dhaka", "Asia/Dhaka", currentTimezone == "Asia/Dhaka");
	emuelec_timezones->add("Asia/Dili", "Asia/Dili", currentTimezone == "Asia/Dili");
	emuelec_timezones->add("Asia/Dubai", "Asia/Dubai", currentTimezone == "Asia/Dubai");
	emuelec_timezones->add("Asia/Dushanbe", "Asia/Dushanbe", currentTimezone == "Asia/Dushanbe");
	emuelec_timezones->add("Asia/Famagusta", "Asia/Famagusta", currentTimezone == "Asia/Famagusta");
	emuelec_timezones->add("Asia/Gaza", "Asia/Gaza", currentTimezone == "Asia/Gaza");
	emuelec_timezones->add("Asia/Hebron", "Asia/Hebron", currentTimezone == "Asia/Hebron");
	emuelec_timezones->add("Asia/Ho_Chi_Minh", "Asia/Ho_Chi_Minh", currentTimezone == "Asia/Ho_Chi_Minh");
	emuelec_timezones->add("Asia/Hong_Kong", "Asia/Hong_Kong", currentTimezone == "Asia/Hong_Kong");
	emuelec_timezones->add("Asia/Hovd", "Asia/Hovd", currentTimezone == "Asia/Hovd");
	emuelec_timezones->add("Asia/Irkutsk", "Asia/Irkutsk", currentTimezone == "Asia/Irkutsk");
	emuelec_timezones->add("Asia/Jakarta", "Asia/Jakarta", currentTimezone == "Asia/Jakarta");
	emuelec_timezones->add("Asia/Jayapura", "Asia/Jayapura", currentTimezone == "Asia/Jayapura");
	emuelec_timezones->add("Asia/Jerusalem", "Asia/Jerusalem", currentTimezone == "Asia/Jerusalem");
	emuelec_timezones->add("Asia/Kabul", "Asia/Kabul", currentTimezone == "Asia/Kabul");
	emuelec_timezones->add("Asia/Kamchatka", "Asia/Kamchatka", currentTimezone == "Asia/Kamchatka");
	emuelec_timezones->add("Asia/Karachi", "Asia/Karachi", currentTimezone == "Asia/Karachi");
	emuelec_timezones->add("Asia/Kathmandu", "Asia/Kathmandu", currentTimezone == "Asia/Kathmandu");
	emuelec_timezones->add("Asia/Khandyga", "Asia/Khandyga", currentTimezone == "Asia/Khandyga");
	emuelec_timezones->add("Asia/Kolkata", "Asia/Kolkata", currentTimezone == "Asia/Kolkata");
	emuelec_timezones->add("Asia/Krasnoyarsk", "Asia/Krasnoyarsk", currentTimezone == "Asia/Krasnoyarsk");
	emuelec_timezones->add("Asia/Kuala_Lumpur", "Asia/Kuala_Lumpur", currentTimezone == "Asia/Kuala_Lumpur");
	emuelec_timezones->add("Asia/Kuching", "Asia/Kuching", currentTimezone == "Asia/Kuching");
	emuelec_timezones->add("Asia/Macau", "Asia/Macau", currentTimezone == "Asia/Macau");
	emuelec_timezones->add("Asia/Magadan", "Asia/Magadan", currentTimezone == "Asia/Magadan");
	emuelec_timezones->add("Asia/Makassar", "Asia/Makassar", currentTimezone == "Asia/Makassar");
	emuelec_timezones->add("Asia/Manila", "Asia/Manila", currentTimezone == "Asia/Manila");
	emuelec_timezones->add("Asia/Nicosia", "Asia/Nicosia", currentTimezone == "Asia/Nicosia");
	emuelec_timezones->add("Asia/Novokuznetsk", "Asia/Novokuznetsk", currentTimezone == "Asia/Novokuznetsk");
	emuelec_timezones->add("Asia/Novosibirsk", "Asia/Novosibirsk", currentTimezone == "Asia/Novosibirsk");
	emuelec_timezones->add("Asia/Omsk", "Asia/Omsk", currentTimezone == "Asia/Omsk");
	emuelec_timezones->add("Asia/Oral", "Asia/Oral", currentTimezone == "Asia/Oral");
	emuelec_timezones->add("Asia/Pontianak", "Asia/Pontianak", currentTimezone == "Asia/Pontianak");
	emuelec_timezones->add("Asia/Pyongyang", "Asia/Pyongyang", currentTimezone == "Asia/Pyongyang");
	emuelec_timezones->add("Asia/Qatar", "Asia/Qatar", currentTimezone == "Asia/Qatar");
	emuelec_timezones->add("Asia/Qostanay", "Asia/Qostanay", currentTimezone == "Asia/Qostanay");
	emuelec_timezones->add("Asia/Qyzylorda", "Asia/Qyzylorda", currentTimezone == "Asia/Qyzylorda");
	emuelec_timezones->add("Asia/Riyadh", "Asia/Riyadh", currentTimezone == "Asia/Riyadh");
	emuelec_timezones->add("Asia/Sakhalin", "Asia/Sakhalin", currentTimezone == "Asia/Sakhalin");
	emuelec_timezones->add("Asia/Samarkand", "Asia/Samarkand", currentTimezone == "Asia/Samarkand");
	emuelec_timezones->add("Asia/Seoul", "Asia/Seoul", currentTimezone == "Asia/Seoul");
	emuelec_timezones->add("Asia/Shanghai", "Asia/Shanghai", currentTimezone == "Asia/Shanghai");
	emuelec_timezones->add("Asia/Singapore", "Asia/Singapore", currentTimezone == "Asia/Singapore");
	emuelec_timezones->add("Asia/Srednekolymsk", "Asia/Srednekolymsk", currentTimezone == "Asia/Srednekolymsk");
	emuelec_timezones->add("Asia/Taipei", "Asia/Taipei", currentTimezone == "Asia/Taipei");
	emuelec_timezones->add("Asia/Tashkent", "Asia/Tashkent", currentTimezone == "Asia/Tashkent");
	emuelec_timezones->add("Asia/Tbilisi", "Asia/Tbilisi", currentTimezone == "Asia/Tbilisi");
	emuelec_timezones->add("Asia/Tehran", "Asia/Tehran", currentTimezone == "Asia/Tehran");
	emuelec_timezones->add("Asia/Thimphu", "Asia/Thimphu", currentTimezone == "Asia/Thimphu");
	emuelec_timezones->add("Asia/Tokyo", "Asia/Tokyo", currentTimezone == "Asia/Tokyo");
	emuelec_timezones->add("Asia/Tomsk", "Asia/Tomsk", currentTimezone == "Asia/Tomsk");
	emuelec_timezones->add("Asia/Ulaanbaatar", "Asia/Ulaanbaatar", currentTimezone == "Asia/Ulaanbaatar");
	emuelec_timezones->add("Asia/Urumqi", "Asia/Urumqi", currentTimezone == "Asia/Urumqi");
	emuelec_timezones->add("Asia/Ust-Nera", "Asia/Ust-Nera", currentTimezone == "Asia/Ust-Nera");
	emuelec_timezones->add("Asia/Vladivostok", "Asia/Vladivostok", currentTimezone == "Asia/Vladivostok");
	emuelec_timezones->add("Asia/Yakutsk", "Asia/Yakutsk", currentTimezone == "Asia/Yakutsk");
	emuelec_timezones->add("Asia/Yangon", "Asia/Yangon", currentTimezone == "Asia/Yangon");
	emuelec_timezones->add("Asia/Yekaterinburg", "Asia/Yekaterinburg", currentTimezone == "Asia/Yekaterinburg");
	emuelec_timezones->add("Asia/Yerevan", "Asia/Yerevan", currentTimezone == "Asia/Yerevan");
	emuelec_timezones->add("Atlantic/Azores", "Atlantic/Azores", currentTimezone == "Atlantic/Azores");
	emuelec_timezones->add("Atlantic/Bermuda", "Atlantic/Bermuda", currentTimezone == "Atlantic/Bermuda");
	emuelec_timezones->add("Atlantic/Canary", "Atlantic/Canary", currentTimezone == "Atlantic/Canary");
	emuelec_timezones->add("Atlantic/Cape_Verde", "Atlantic/Cape_Verde", currentTimezone == "Atlantic/Cape_Verde");
	emuelec_timezones->add("Atlantic/Faroe", "Atlantic/Faroe", currentTimezone == "Atlantic/Faroe");
	emuelec_timezones->add("Atlantic/Madeira", "Atlantic/Madeira", currentTimezone == "Atlantic/Madeira");
	emuelec_timezones->add("Atlantic/Reykjavik", "Atlantic/Reykjavik", currentTimezone == "Atlantic/Reykjavik");
	emuelec_timezones->add("Atlantic/South_Georgia", "Atlantic/South_Georgia", currentTimezone == "Atlantic/South_Georgia");
	emuelec_timezones->add("Atlantic/Stanley", "Atlantic/Stanley", currentTimezone == "Atlantic/Stanley");
	emuelec_timezones->add("Australia/Adelaide", "Australia/Adelaide", currentTimezone == "Australia/Adelaide");
	emuelec_timezones->add("Australia/Brisbane", "Australia/Brisbane", currentTimezone == "Australia/Brisbane");
	emuelec_timezones->add("Australia/Broken_Hill", "Australia/Broken_Hill", currentTimezone == "Australia/Broken_Hill");
	emuelec_timezones->add("Australia/Darwin", "Australia/Darwin", currentTimezone == "Australia/Darwin");
	emuelec_timezones->add("Australia/Eucla", "Australia/Eucla", currentTimezone == "Australia/Eucla");
	emuelec_timezones->add("Australia/Hobart", "Australia/Hobart", currentTimezone == "Australia/Hobart");
	emuelec_timezones->add("Australia/Lindeman", "Australia/Lindeman", currentTimezone == "Australia/Lindeman");
	emuelec_timezones->add("Australia/Lord_Howe", "Australia/Lord_Howe", currentTimezone == "Australia/Lord_Howe");
	emuelec_timezones->add("Australia/Melbourne", "Australia/Melbourne", currentTimezone == "Australia/Melbourne");
	emuelec_timezones->add("Australia/Perth", "Australia/Perth", currentTimezone == "Australia/Perth");
	emuelec_timezones->add("Australia/Sydney", "Australia/Sydney", currentTimezone == "Australia/Sydney");
	emuelec_timezones->add("Europe/Amsterdam", "Europe/Amsterdam", currentTimezone == "Europe/Amsterdam");
	emuelec_timezones->add("Europe/Andorra", "Europe/Andorra", currentTimezone == "Europe/Andorra");
	emuelec_timezones->add("Europe/Astrakhan", "Europe/Astrakhan", currentTimezone == "Europe/Astrakhan");
	emuelec_timezones->add("Europe/Athens", "Europe/Athens", currentTimezone == "Europe/Athens");
	emuelec_timezones->add("Europe/Belgrade", "Europe/Belgrade", currentTimezone == "Europe/Belgrade");
	emuelec_timezones->add("Europe/Berlin", "Europe/Berlin", currentTimezone == "Europe/Berlin");
	emuelec_timezones->add("Europe/Brussels", "Europe/Brussels", currentTimezone == "Europe/Brussels");
	emuelec_timezones->add("Europe/Bucharest", "Europe/Bucharest", currentTimezone == "Europe/Bucharest");
	emuelec_timezones->add("Europe/Budapest", "Europe/Budapest", currentTimezone == "Europe/Budapest");
	emuelec_timezones->add("Europe/Chisinau", "Europe/Chisinau", currentTimezone == "Europe/Chisinau");
	emuelec_timezones->add("Europe/Copenhagen", "Europe/Copenhagen", currentTimezone == "Europe/Copenhagen");
	emuelec_timezones->add("Europe/Dublin", "Europe/Dublin", currentTimezone == "Europe/Dublin");
	emuelec_timezones->add("Europe/Gibraltar", "Europe/Gibraltar", currentTimezone == "Europe/Gibraltar");
	emuelec_timezones->add("Europe/Helsinki", "Europe/Helsinki", currentTimezone == "Europe/Helsinki");
	emuelec_timezones->add("Europe/Istanbul", "Europe/Istanbul", currentTimezone == "Europe/Istanbul");
	emuelec_timezones->add("Europe/Kaliningrad", "Europe/Kaliningrad", currentTimezone == "Europe/Kaliningrad");
	emuelec_timezones->add("Europe/Kiev", "Europe/Kiev", currentTimezone == "Europe/Kiev");
	emuelec_timezones->add("Europe/Kirov", "Europe/Kirov", currentTimezone == "Europe/Kirov");
	emuelec_timezones->add("Europe/Lisbon", "Europe/Lisbon", currentTimezone == "Europe/Lisbon");
	emuelec_timezones->add("Europe/London", "Europe/London", currentTimezone == "Europe/London");
	emuelec_timezones->add("Europe/Luxembourg", "Europe/Luxembourg", currentTimezone == "Europe/Luxembourg");
	emuelec_timezones->add("Europe/Madrid", "Europe/Madrid", currentTimezone == "Europe/Madrid");
	emuelec_timezones->add("Europe/Malta", "Europe/Malta", currentTimezone == "Europe/Malta");
	emuelec_timezones->add("Europe/Minsk", "Europe/Minsk", currentTimezone == "Europe/Minsk");
	emuelec_timezones->add("Europe/Monaco", "Europe/Monaco", currentTimezone == "Europe/Monaco");
	emuelec_timezones->add("Europe/Moscow", "Europe/Moscow", currentTimezone == "Europe/Moscow");
	emuelec_timezones->add("Europe/Oslo", "Europe/Oslo", currentTimezone == "Europe/Oslo");
	emuelec_timezones->add("Europe/Paris", "Europe/Paris", currentTimezone == "Europe/Paris");
	emuelec_timezones->add("Europe/Prague", "Europe/Prague", currentTimezone == "Europe/Prague");
	emuelec_timezones->add("Europe/Riga", "Europe/Riga", currentTimezone == "Europe/Riga");
	emuelec_timezones->add("Europe/Rome", "Europe/Rome", currentTimezone == "Europe/Rome");
	emuelec_timezones->add("Europe/Samara", "Europe/Samara", currentTimezone == "Europe/Samara");
	emuelec_timezones->add("Europe/Saratov", "Europe/Saratov", currentTimezone == "Europe/Saratov");
	emuelec_timezones->add("Europe/Simferopol", "Europe/Simferopol", currentTimezone == "Europe/Simferopol");
	emuelec_timezones->add("Europe/Sofia", "Europe/Sofia", currentTimezone == "Europe/Sofia");
	emuelec_timezones->add("Europe/Stockholm", "Europe/Stockholm", currentTimezone == "Europe/Stockholm");
	emuelec_timezones->add("Europe/Tallinn", "Europe/Tallinn", currentTimezone == "Europe/Tallinn");
	emuelec_timezones->add("Europe/Tirane", "Europe/Tirane", currentTimezone == "Europe/Tirane");
	emuelec_timezones->add("Europe/Ulyanovsk", "Europe/Ulyanovsk", currentTimezone == "Europe/Ulyanovsk");
	emuelec_timezones->add("Europe/Uzhgorod", "Europe/Uzhgorod", currentTimezone == "Europe/Uzhgorod");
	emuelec_timezones->add("Europe/Vienna", "Europe/Vienna", currentTimezone == "Europe/Vienna");
	emuelec_timezones->add("Europe/Vilnius", "Europe/Vilnius", currentTimezone == "Europe/Vilnius");
	emuelec_timezones->add("Europe/Volgograd", "Europe/Volgograd", currentTimezone == "Europe/Volgograd");
	emuelec_timezones->add("Europe/Warsaw", "Europe/Warsaw", currentTimezone == "Europe/Warsaw");
	emuelec_timezones->add("Europe/Zaporozhye", "Europe/Zaporozhye", currentTimezone == "Europe/Zaporozhye");
	emuelec_timezones->add("Europe/Zurich", "Europe/Zurich", currentTimezone == "Europe/Zurich");
	emuelec_timezones->add("Indian/Chagos", "Indian/Chagos", currentTimezone == "Indian/Chagos");
	emuelec_timezones->add("Indian/Christmas", "Indian/Christmas", currentTimezone == "Indian/Christmas");
	emuelec_timezones->add("Indian/Cocos", "Indian/Cocos", currentTimezone == "Indian/Cocos");
	emuelec_timezones->add("Indian/Kerguelen", "Indian/Kerguelen", currentTimezone == "Indian/Kerguelen");
	emuelec_timezones->add("Indian/Mahe", "Indian/Mahe", currentTimezone == "Indian/Mahe");
	emuelec_timezones->add("Indian/Maldives", "Indian/Maldives", currentTimezone == "Indian/Maldives");
	emuelec_timezones->add("Indian/Mauritius", "Indian/Mauritius", currentTimezone == "Indian/Mauritius");
	emuelec_timezones->add("Indian/Reunion", "Indian/Reunion", currentTimezone == "Indian/Reunion");
	emuelec_timezones->add("Pacific/Apia", "Pacific/Apia", currentTimezone == "Pacific/Apia");
	emuelec_timezones->add("Pacific/Auckland", "Pacific/Auckland", currentTimezone == "Pacific/Auckland");
	emuelec_timezones->add("Pacific/Bougainville", "Pacific/Bougainville", currentTimezone == "Pacific/Bougainville");
	emuelec_timezones->add("Pacific/Chatham", "Pacific/Chatham", currentTimezone == "Pacific/Chatham");
	emuelec_timezones->add("Pacific/Chuuk", "Pacific/Chuuk", currentTimezone == "Pacific/Chuuk");
	emuelec_timezones->add("Pacific/Easter", "Pacific/Easter", currentTimezone == "Pacific/Easter");
	emuelec_timezones->add("Pacific/Efate", "Pacific/Efate", currentTimezone == "Pacific/Efate");
	emuelec_timezones->add("Pacific/Enderbury", "Pacific/Enderbury", currentTimezone == "Pacific/Enderbury");
	emuelec_timezones->add("Pacific/Fakaofo", "Pacific/Fakaofo", currentTimezone == "Pacific/Fakaofo");
	emuelec_timezones->add("Pacific/Fiji", "Pacific/Fiji", currentTimezone == "Pacific/Fiji");
	emuelec_timezones->add("Pacific/Funafuti", "Pacific/Funafuti", currentTimezone == "Pacific/Funafuti");
	emuelec_timezones->add("Pacific/Galapagos", "Pacific/Galapagos", currentTimezone == "Pacific/Galapagos");
	emuelec_timezones->add("Pacific/Gambier", "Pacific/Gambier", currentTimezone == "Pacific/Gambier");
	emuelec_timezones->add("Pacific/Guadalcanal", "Pacific/Guadalcanal", currentTimezone == "Pacific/Guadalcanal");
	emuelec_timezones->add("Pacific/Guam", "Pacific/Guam", currentTimezone == "Pacific/Guam");
	emuelec_timezones->add("Pacific/Honolulu", "Pacific/Honolulu", currentTimezone == "Pacific/Honolulu");
	emuelec_timezones->add("Pacific/Kiritimati", "Pacific/Kiritimati", currentTimezone == "Pacific/Kiritimati");
	emuelec_timezones->add("Pacific/Kosrae", "Pacific/Kosrae", currentTimezone == "Pacific/Kosrae");
	emuelec_timezones->add("Pacific/Kwajalein", "Pacific/Kwajalein", currentTimezone == "Pacific/Kwajalein");
	emuelec_timezones->add("Pacific/Majuro", "Pacific/Majuro", currentTimezone == "Pacific/Majuro");
	emuelec_timezones->add("Pacific/Marquesas", "Pacific/Marquesas", currentTimezone == "Pacific/Marquesas");
	emuelec_timezones->add("Pacific/Nauru", "Pacific/Nauru", currentTimezone == "Pacific/Nauru");
	emuelec_timezones->add("Pacific/Niue", "Pacific/Niue", currentTimezone == "Pacific/Niue");
	emuelec_timezones->add("Pacific/Norfolk", "Pacific/Norfolk", currentTimezone == "Pacific/Norfolk");
	emuelec_timezones->add("Pacific/Noumea", "Pacific/Noumea", currentTimezone == "Pacific/Noumea");
	emuelec_timezones->add("Pacific/Pago_Pago", "Pacific/Pago_Pago", currentTimezone == "Pacific/Pago_Pago");
	emuelec_timezones->add("Pacific/Palau", "Pacific/Palau", currentTimezone == "Pacific/Palau");
	emuelec_timezones->add("Pacific/Pitcairn", "Pacific/Pitcairn", currentTimezone == "Pacific/Pitcairn");
	emuelec_timezones->add("Pacific/Pohnpei", "Pacific/Pohnpei", currentTimezone == "Pacific/Pohnpei");
	emuelec_timezones->add("Pacific/Port_Moresby", "Pacific/Port_Moresby", currentTimezone == "Pacific/Port_Moresby");
	emuelec_timezones->add("Pacific/Rarotonga", "Pacific/Rarotonga", currentTimezone == "Pacific/Rarotonga");
	emuelec_timezones->add("Pacific/Tahiti", "Pacific/Tahiti", currentTimezone == "Pacific/Tahiti");
	emuelec_timezones->add("Pacific/Tarawa", "Pacific/Tarawa", currentTimezone == "Pacific/Tarawa");
	emuelec_timezones->add("Pacific/Tongatapu", "Pacific/Tongatapu", currentTimezone == "Pacific/Tongatapu");
	emuelec_timezones->add("Pacific/Wake", "Pacific/Wake", currentTimezone == "Pacific/Wake");
	emuelec_timezones->add("Pacific/Wallis", "Pacific/Wallis", currentTimezone == "Pacific/Wallis");
	// End Hardcode TZ
